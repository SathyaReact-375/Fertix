...
import '../Components/assets/css/GrowBagsPage.css';
import { FaHeart } from "react-icons/fa";

const GrowBagsProductsPage = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const growBagsData = response.data.find(category => category.category === "Grow Bags");
        setProducts(growBagsData ? growBagsData.products : []);
      } catch (error) {
        console.error('Error fetching Grow Bags products:', error);
      }
      setLoading(false);
    };
  ...
  if (loading) {
    return <div className="loading">Loading Grow Bags...</div>;
  }

  return (
    <div className="growbags-products-page">
...
export default GrowBagsProductsPage;