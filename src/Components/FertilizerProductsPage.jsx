...
import '../Components/assets/css/FertilizerPage.css';
import { FaHeart } from "react-icons/fa";

const FertilizerProductsPage = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const fertilizerData = response.data.find(category => category.category === "Fertilizers");
        setProducts(fertilizerData ? fertilizerData.products : []);
      } catch (error) {
  ...
  if (loading) {
    return <div className="loading">Loading Fertilizer Products...</div>;
  }
...
export default FertilizerProductsPage;